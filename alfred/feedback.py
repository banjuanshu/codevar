...
if __name__ == '__main__':
	fb = Feedback()
	#fb.addItem(title='Feedback Title', subtitle='subtitle', autocomplete='subcmd', valid=False)
	#fb.addItem(title='Feedback Title 2', subtitle='subtitle 2', arg='arg')
	kwargs = {'title':'Feedback Title', 'subtitle':'subtitle', 'autocomplete':'subcmd', 'valid':'False'}
	fb.addItem(**kwargs)
	fb.output()
